...
SECRET_KEY = 'django-insecure-^%pphouc6kh6@e7drgcr!g4y&@0umm0xq-971pai*5&#0@o1)v'
...
MIDDLEWARE = [
    ...
    'core.middleware.HostnameHeaderMiddleware'
]

DATABASE_ROUTERS = ['core.db_router.CustomDatabaseRouter']
